...
The good news: you're not locked into one provider. Connect local models through Ollama, cloud models through OpenAI, or mix both. Add more anytime. [Switch between them mid-conversation](/features/evaluation) if you want.
